...
const logoCopies = [
  { from: path.join(root, "negatif.png"), to: path.join(publicDir, "negatif.png") },
  { from: path.join(root, "negatif_vectorized.png"), to: path.join(publicDir, "negatif_vectorized.png") },
